...
{
    public class AlterarContatoRequest<T> : Notifiable, IRequestValidation, IRequest<T>
    {
        public AlterarContatoRequest(Contato contato)
        {
        ...
        public void Validar()
        {
            ...
            {
                AddNotification(nameof(Contato.Id), $"A propriedade '{nameof(Contato.Id)}' é obrigatória");
            }
